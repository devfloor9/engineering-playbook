...
> 상세 아키텍처는 [Inference Gateway 라우팅](../gateway-agents/inference-gateway-routing.md)을 참조하세요.
...
> 2-Tier Gateway 아키텍처의 전체 설계는 [LLM Gateway 2-Tier 아키텍처](../gateway-agents/inference-gateway-routing.md)를 참조하세요.
