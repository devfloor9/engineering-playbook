...
> 상세 아키텍처는 [Inference Gateway 라우팅](../reference-architecture/inference-gateway/routing-strategy.md)을 참조하세요.
...
> 2-Tier Gateway 아키텍처의 전체 설계는 [LLM Gateway 2-Tier 아키텍처](../reference-architecture/inference-gateway/routing-strategy.md)를 참조하세요.
...
- [플랫폼 아키텍처](./agentic-platform-architecture.md) — 전체 시스템 설계
