...
<DocCardGrid columns={2}>
  ...
  />
  <DocCard
    to="/docs/agentic-ai-platform/design-architecture/ai-platform-decision-framework"
    icon="🧭"
    title="AI 플랫폼 선택 가이드"
    description="SageMaker Unified Studio, Bedrock AgentCore, EKS 오픈 아키텍처 중 고객 상황에 맞는 최적 접근 선택을 위한 의사결정 프레임워크. 5축 비교, 성숙도별 권장 경로, 하이브리드 패턴."
    color="#0ea5e9"
  />
  <DocCard
...
:::tip 권장 학습 순서
**플랫폼 아키텍처**(무엇) → **기술적 도전과제**(왜) → **AI 플랫폼 선택 가이드**(어떤 접근) → **AWS Native** 또는 **EKS 오픈 아키텍처**(어떻게) 순서로 읽으면 전체 맥락을 가장 효과적으로 이해할 수 있습니다.
:::
