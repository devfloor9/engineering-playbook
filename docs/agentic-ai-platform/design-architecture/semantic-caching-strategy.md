...
Bifrost/LiteLLM의 OTel 전송 설정은 기존 [LLMOps Observability](../operations-mlops/llmops-observability) 및 [추론 게이트웨이 구성 가이드](../reference-architecture/inference-gateway-setup) 문서를 따릅니다. 캐시 관련 태그는 애플리케이션/게이트웨이 플러그인 레이어에서 span attribute로 추가합니다.
...
- [추론 게이트웨이 라우팅 전략](../reference-architecture/inference-gateway-routing)
...
- [Milvus 벡터 데이터베이스](../operations-mlops/milvus-vector-database)
- [Ragas 평가](../operations-mlops/ragas-evaluation)
