...
## 3. Langfuse OTel trace 기반 misroute 탐지
...
### 모니터링 및 비용
- [Agent 모니터링](../operations-mlops/agent-monitoring.md) - Langfuse 아키텍처, 핵심 메트릭, 알림 전략
