...
<DocCardGrid columns={2}>
  <DocCard
    to="/engineering-playbook/docs/agentic-ai-platform/gateway-agents/inference-gateway-routing"
    icon="🌐"
  ...
  />
  <DocCard
    to="/engineering-playbook/docs/agentic-ai-platform/gateway-agents/llm-gateway-architecture"
    icon="🔄"
  ...
  />
  <DocCard
    to="/engineering-playbook/docs/agentic-ai-platform/gateway-agents/openclaw-ai-gateway"
    icon="🦞"
