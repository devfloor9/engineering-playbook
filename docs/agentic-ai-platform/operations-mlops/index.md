...
<DocCardGrid columns={2}>
  <DocCard
    to="/engineering-playbook/docs/agentic-ai-platform/operations-mlops/agent-monitoring"
    icon="📈"
    title="Agent 모니터링 & 운영"
  ...
  />
  <DocCard
    to="/engineering-playbook/docs/agentic-ai-platform/operations-mlops/ragas-evaluation"
    icon="✅"
    title="Ragas 평가"
  ...
  />
  <DocCard
    to="/engineering-playbook/docs/agentic-ai-platform/operations-mlops/llmops-observability"
    icon="👁️"
  ...
  />
  <DocCard
    to="/engineering-playbook/docs/agentic-ai-platform/operations-mlops/mlops-pipeline-eks"
    icon="⚙️"
    title="MLOps 파이프라인"
  ...
  />
  <DocCard
    to="/engineering-playbook/docs/agentic-ai-platform/operations-mlops/sagemaker-eks-integration"
    icon="🔬"
