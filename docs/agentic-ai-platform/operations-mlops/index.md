...
:::tip 실전 배포 가이드
MLOps 파이프라인 구축 및 SageMaker-EKS 통합 등 실제 배포 아키텍처는 [Reference Architecture](../reference-architecture/) 섹션을 참조하세요.
:::
...
- **[AIDLC > AgenticOps](/docs/aidlc/agentic-ops/index)**: AIOps 기반 자동화된 운영 및 예측 모니터링
