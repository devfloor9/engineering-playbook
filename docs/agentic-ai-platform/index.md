...
- [AWS Native 플랫폼](./design-architecture/aws-native-agentic-platform.md) — 매니지드 서비스 기반 Agent 개발
- [EKS 기반 오픈 아키텍처](./design-architecture/agentic-ai-solutions-eks.md) — 오픈소스 기반 Open Architecture
...
2. [AWS Native 플랫폼](./design-architecture/aws-native-agentic-platform.md) 또는 [EKS 기반 오픈 아키텍처](./design-architecture/agentic-ai-solutions-eks.md) - 접근 전략 선택
