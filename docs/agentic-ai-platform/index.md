...
- [EKS 기반 해결방안](./design-architecture/agentic-ai-solutions-eks.md) — 오픈소스 기반 Open Architecture
...
2. [AWS Native 플랫폼](./design-architecture/aws-native-agentic-platform.md) 또는 [EKS 기반 해결방안](./design-architecture/agentic-ai-solutions-eks.md) - 접근 전략 선택
