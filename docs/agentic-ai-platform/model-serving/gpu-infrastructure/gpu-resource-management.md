...
:::info Karpenter v1.13+ (GA since v1.0)
Karpenter는 v1.0부터 GA 상태이며, 본 문서의 모든 예제는 `karpenter.sh/v1` API를 사용합니다. 현재 최신 버전은 v1.13입니다.
:::
...
- **K8s 1.33**: Beta (`v1beta1/v1beta2`, 기본 활성화)
- **K8s 1.34**: **DRA GA** (`resource.k8s.io/v1`, 기본 활성화)
- **K8s 1.35**: locked-by-default (stable 유지)
:::
