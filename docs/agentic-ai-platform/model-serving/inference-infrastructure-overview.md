...
상세 구현과 평가 결과는 [라우팅 전략 — Request Cascading: 지능형 모델 라우팅](./inference-routing/routing-strategy.md#request-cascading-지능형-모델-라우팅)을 참조하세요. 의미 기반 캐시와의 관계는 [Semantic Caching 전략](./inference-optimization/semantic-caching-strategy.md)에서 다룹니다.
