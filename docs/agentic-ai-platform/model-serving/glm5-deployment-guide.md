...
**Kiro 호스팅 변동 비용 (Bedrock 유사 MoE 모델 기준 추정):**

- Input: ~$0.003/1K tokens, Output: ~$0.012/1K tokens
- 평균 요청 (1K input + 500 output): **~$0.009/요청**

**손익분기: ~990,000 요청/월 ($8,900 ÷ $0.009)**

| 월 요청량 | Kiro 비용 (USD) | 자체 호스팅 (USD) | 절감률 | 권장 |
|----------|----------------|-----------------|-------|------|
| 100,000 | ~$900 | $8,900 | - | **Kiro** |
| 500,000 | ~$4,500 | $8,900 | - | **Kiro** |
| 1,000,000 | ~$9,000 | $8,900 | 1% | **손익분기** |
| 3,000,000 | ~$27,000 | $8,900 | 67% | **자체 호스팅** |
| 5,000,000 | ~$45,000 | $8,900 | 80% | **자체 호스팅** |
| 10,000,000 | ~$90,000 | $8,900 | 90% | **자체 호스팅** |

#### 자체 호스팅 비용 최적화 옵션 (Kiro에서 불가능)

| 최적화 | 효과 | 설명 |
|--------|------|------|
| **Cascade Routing** | 70-80% 비용 절감 | 간단한 요청은 SLM (8B)으로, 복잡한 요청만 GLM-5로 |
...
:::tip Cascade Routing 적용 시 손익분기 변화
SLM으로 70% 요청을 오프로드하면 자체 호스팅 실효 처리량이 3.3배 증가합니다.

| | 비용 | 실효 요청당 비용 |
|---|---|---|
| 자체 호스팅 (GLM-5 단독) | $8,900/월 | ~$0.009 |
| 자체 호스팅 (+ SLM Cascade) | $9,400/월 (+$500) | **~$0.003** |
| Kiro | 사용량 비례 | ~$0.009 |

Cascade 적용 시 손익분기가 **~$9,400 ÷ $0.009 = 약 330,000 요청/월**로 앞당겨집니다.
:::
...
| 기준 | Threshold | 권장 |
|------|-----------|------|
| 월 요청량 50만 미만 | $4,500 이하 | **Kiro** |
| 월 요청량 100만+ | $9,000+ | **자체 호스팅** |
| Cascade 적용 시 월 30만+ | $2,700+ | **자체 호스팅** |
| LoRA/컴플라이언스 필요 | 요청량 무관 | **자체 호스팅** |
| 빠른 프로토타이핑 | 요청량 무관 | **Kiro** |
