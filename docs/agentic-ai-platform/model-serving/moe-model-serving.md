...
> **현재 버전**: vLLM v0.6.3 / v0.7.x (2025-02 안정 버전)
...
GLM-5, Kimi K2.5와 같은 700B+ MoE 모델은 단일 노드에 로드할 수 없어 멀티노드 배포가 필수입니다. vLLM v0.6+에서는 **LeaderWorkerSet(LWS)** 기반 멀티노드 배포를 지원합니다.
