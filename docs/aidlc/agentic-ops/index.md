...
description: "AIDLC로 개발한 소프트웨어의 운영과 개선을 위한 AI 에이전트 기반 피드백 루프 구축 가이드"
last_update:
  date: 2026-03-23
  author: devfloor9
---
...
# AgenticOps: AI 에이전트 기반 운영 피드백 루프

> **읽는 시간**: 약 3분

AgenticOps는 [AIDLC](/docs/aidlc)로 소프트웨어를 개발한 이후, **실제 운영 환경에서의 지속적 개선을 위한 피드백 루프를 AI 에이전트를 통해 자율적으로 구축하는 접근 방법**입니다. 기존 AIOps가 AI를 모니터링 보조 도구로 활용했다면, AgenticOps는 AI 에이전트가 관찰성 데이터를 기반으로 **감지 → 판단 → 실행**까지 자율적으로 수행하는 다음 단계입니다.
...
1. [AgenticOps 전략 가이드](./aiops-introduction.md) — 전체 방향성과 AWS 오픈소스 전략
