...
title: "방법론"
sidebar_label: "방법론"
description: "AIDLC의 핵심 방법론 — 10대 원칙, 온톨로지, 하네스 엔지니어링, DDD 통합"
last_update:
  date: 2026-04-07
  author: devfloor9
---
...
| 순서 | 문서 | 핵심 질문 |
|------|------|----------|
| 1 | [10대 원칙과 실행 모델](./principles-and-model.md) | AIDLC는 무엇이고, 어떻게 동작하는가? |
| 2 | [온톨로지 엔지니어링](./ontology-engineering.md) | AI가 생성하는 코드의 **정확성**을 어떻게 보장하는가? |
| 3 | [하네스 엔지니어링](./harness-engineering.md) | AI 실행의 **안전성**을 어떻게 아키텍처로 강제하는가? |
