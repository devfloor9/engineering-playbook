...
AIDLC로 소프트웨어를 개발한 이후, 실제 운영 환경에서의 **지속적 개선과 피드백 루프**가 필요합니다. 이를 위한 접근 방법으로 [AIOps](/docs/aiops)를 참조하세요. AIOps는 AI를 활용하여 운영 관찰성, 예측 스케일링, 자동 복구 등 운영 효율화를 위한 피드백 루프를 체계적으로 구축하는 방법론입니다.
...
2. [AIOps](/docs/aiops) — 개발 이후 운영 피드백 루프 구축
:::
