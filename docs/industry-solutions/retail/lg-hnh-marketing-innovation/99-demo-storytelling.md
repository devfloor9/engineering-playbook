...
> "오늘 보여드릴 데모는 GS Caltex M&M본부에서 같은 고민(부서 데이터 사일로 + 시각 격차)을 풀기 위해 진행한 PoC를 **LG생활건강 마케팅 혁신 컨텍스트로 재설계**한 것입니다. **컨셉이 아닌 동작 시연** — N=500~5,000 LG 멤버스 실데이터 + 49.5K 합성 + **외부 4종 시그널 라이브** 가 모두 작동합니다."
