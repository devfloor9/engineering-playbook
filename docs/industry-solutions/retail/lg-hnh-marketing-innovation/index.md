...
# LG H&H Marketing Innovation PoC

> **"자사 회원·SKU·캠페인·옴니채널 거래 데이터를 외부 트렌드·기상·경제·경쟁사 시그널과 묶어 온톨로지 + Agentic AI로 풀어내는 마케팅 혁신 PoC"**

GS Caltex M&M본부 PoC ([gcc.whchoi.net](https://gcc.whchoi.net/)) 의 **본질** — *"흩어진 데이터를 의미적으로 연결해 부서별 시각으로 활용하는 동작 시연"* — 을 LG생활건강 마케팅 혁신 컨텍스트로 재설계한 자료. 공개 정보만 활용.

---

## 🚀 인터랙티브 데모

> **[👉 데모 페이지 열기 (새 창)](pathname:///demo/lg-hnh/)**

8 시나리오를 사이드바에서 전환하며 페르소나 스위처·차트·KG 그래프·SSE 챗봇 트레이스·Swimlane 타임라인 등 GCC UI 패턴을 직접 체험할 수 있습니다.
