...
## 2. 사용자 스토리
> P4(CRM·LG 멤버스) — 정해진 테스트 사례를 실행하고 판단 로그를 확인합니다. 마케팅에 동의하지 않은 회원에게는 캠페인 발송이 차단돼야 하고, 챗봇 응답에서는 개인식별정보(PII)가 마스킹돼야 합니다. 미성년자로 분류된 회원을 대상으로 한 화장품 캠페인도 차단돼야 합니다. 각 결과에 적용한 정책과 판단 이유를 표시합니다.
