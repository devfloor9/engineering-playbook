...
[4. Kyverno 기반 정책 관리](./kyverno-policy-management.md) - Kyverno v1.17+ (현재 v1.18) CEL v1 GA, 네임스페이스 수준 정책, 정책 예외 관리, OPA Gatekeeper 비교
...
:::info EKS Pod Identity (2024+ 권장, IRSA 대체)
