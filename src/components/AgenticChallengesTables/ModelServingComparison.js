    ...
    lineHeight: '1.6'
      ...
      borderRadius: '8px 8px 0 0'
        ...
        marginBottom: '4px'
          ...
          {isKo ? '🚀 모델 서빙 솔루션 비교' : '🚀 Model Serving Solutions'}
        </div>
        <div style={{
        fontSize: '14px',
        opacity: 0.9
      }}>
          {isKo ? 'vLLM vs llm-d 역할과 기능' : 'vLLM vs llm-d roles and capabilities'}
        </div>
      </div>
      ...
      borderRadius: '0 0 8px 8px'
        ...
        borderTop: '1px solid var(--ifm-color-emphasis-200)'
          ...
          gap: '8px'
            ...
            <span>
              {isKo ? 'vLLM은 추론 최적화를, llm-d는 분산 스케줄링을 담당하여 상호 보완적으로 작동합니다.' : 'vLLM handles inference optimization while llm-d manages distributed scheduling in a complementary manner.'}
            </span>
          </div>
        </div>
      </div>
