    ...
    lineHeight: '1.6'
      ...
      borderRadius: '8px 8px 0 0'
        ...
        marginBottom: '4px'
          ...
          {isKo ? '☸️ Kubernetes 핵심 기능 활용' : '☸️ Kubernetes Core Features'}
        </div>
        <div style={{
        fontSize: '14px',
        opacity: 0.9
      }}>
          {isKo ? 'AI 플랫폼 적용 방안과 해결되는 도전과제' : 'AI platform applications and challenges addressed'}
        </div>
      </div>
      ...
      padding: '20px'
          ...
          borderLeft: '4px solid #326ce5'
            ...
            alignItems: 'start'
                ...
                marginBottom: '4px'
                    ...
                    {isKo ? 'AI 플랫폼 적용' : 'AI Platform Application'}
                  </div>
                  <div style={{
                fontSize: '14px',
                color: 'var(--ifm-font-color-base)'
                ...
                flexWrap: 'wrap'
                    ...
                    {item.challenges.map((ch, idx) => <span key={idx} style={{
        ...
        border: '1px solid var(--ifm-color-emphasis-200)'
          ...
          flexWrap: 'wrap'
            ...
            {Object.entries(challengeLabels).map(([num, label]) => <div key={num} style={{
            display: 'flex',
            alignItems: 'center',
            gap: '6px'
          }}>
