  ...
  return <div style={{
    ...
    fontSize: '15px'
      ...
      fontSize: '16px'
        ...
        {isKo ? 'GPU 노드 요구사항' : 'GPU Node Requirements'}
      </div>
          ...
          <thead>
            ...
            background: 'var(--ifm-color-emphasis-100)'
              ...
              fontWeight: '600'
                ...
                {isKo ? '권장 인스턴스' : 'Recommended Instance'}
              </th>
              <th style={{
              padding: '12px',
              textAlign: 'left',
              ...
              fontWeight: '600'
                ...
                {isKo ? '메모리 요구' : 'Memory Required'}
              </th>
            </tr>
          </thead>
          <tbody>
            {requirements.map((row, index) => <tr key={index} style={{
