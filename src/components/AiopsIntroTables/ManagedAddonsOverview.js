  ...
  return <div style={{
    ...
    lineHeight: '1.6'
      ...
      overflow: 'hidden'
        ...
        {categories.map((cat, idx) => <div key={cat.name} style={{
        display: 'grid',
        ...
        borderBottom: idx < categories.length - 1 ? '1px solid #f3f4f6' : 'none'
          ...
          gap: '8px'
            ...
            gap: '6px'
                ...
                {cat.addons.map(addon => <span key={addon} style={{
        ...
        lineHeight: '1.6'
          ...
          <strong>{isKo ? '핵심:' : 'Key:'}</strong> {isKo ? 'Managed Add-on은 AWS가 설치·업그레이드·보안 패치를 관리합니다.' : 'AWS manages installation, upgrades, and security patches for Managed Add-ons.'}
          <code style={{
