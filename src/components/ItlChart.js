...
const scoutData = [
  { id: 'A', label: 'p5/H100', color: 'var(--ifm-color-emphasis-600)', value: 8 },
  { id: 'B', label: 'p4d/A100', color: '#8b5cf6', value: 18 },
  { id: 'C', label: 'g6e/L40S', color: '#f59e0b', value: 22 },
  { id: 'D', label: 'trn2', color: '#3b82f6', value: 10 },
  { id: 'E', label: 'inf2', color: '#10b981', value: 14 },
];

const maverickData = [
  { id: 'A', label: 'p5/H100', color: 'var(--ifm-color-emphasis-600)', value: 12 },
  { id: 'D', label: 'trn2', color: '#3b82f6', value: 15 },
];
...
export default function ItlChart({ locale = 'en' }) {
