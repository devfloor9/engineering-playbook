...
const scoutData = [
  { id: 'A', label: 'p5/H100', color: 'var(--ifm-color-emphasis-600)', value: 120 },
  { id: 'B', label: 'p4d/A100', color: '#8b5cf6', value: 280 },
  { id: 'C', label: 'g6e/L40S', color: '#f59e0b', value: 350 },
  { id: 'D', label: 'trn2', color: '#3b82f6', value: 150 },
  { id: 'E', label: 'inf2', color: '#10b981', value: 200 },
];

const maverickData = [
  { id: 'A', label: 'p5/H100', color: 'var(--ifm-color-emphasis-600)', value: 250 },
  { id: 'D', label: 'trn2', color: '#3b82f6', value: 300 },
];
...
export default function TtftChart({ locale = 'en' }) {
  ...
  const lowestScout = Math.min(...scoutData.map(s => s.value));
  const lowestMaverick = Math.min(...maverickData.map(s => s.value));
  const maxValue = 400;
