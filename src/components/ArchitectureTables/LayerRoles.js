    ...
    fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif'
      ...
      borderRadius: '8px 8px 0 0'
        ...
        fontWeight: '600'
          ...
          {isKo ? '런타임 레이어 (6) — 요청 경로' : 'Runtime Layers (6) — Request Path'}
        </div>
      </div>
      ...
      overflow: 'hidden'
        ...
        {layers.map((layer, index) => <div key={index} style={{
        display: 'grid',
        gridTemplateColumns: cellGrid,
        padding: '16px 20px',
      ...
      borderRadius: '8px 8px 0 0'
        ...
        fontWeight: '600'
          ...
          {isKo ? '횡단 플레인 (3) — 전 레이어 관통' : 'Cross-cutting Planes (3) — Span All Layers'}
        </div>
      </div>
      ...
      overflow: 'hidden'
        ...
        {planes.map((plane, index) => <div key={index} style={{
        display: 'grid',
        gridTemplateColumns: cellGrid,
        padding: '16px 20px',
