        ...
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          <thead>
            <tr style={{ background: 'var(--ifm-color-emphasis-100)' }}>
              <th style={{ padding: '0.75rem 1rem', textAlign: 'left', fontSize: '0.8rem', fontWeight: 600, color: '#2e7d32', borderBottom: '2px solid #2e7d32' }}>{headers.component}</th>
              <th style={{ padding: '0.75rem 1rem', textAlign: 'center', fontSize: '0.8rem', fontWeight: 600, color: '#2e7d32', borderBottom: '2px solid #2e7d32' }}>{headers.alb}</th>
              <th style={{ padding: '0.75rem 1rem', textAlign: 'center', fontSize: '0.8rem', fontWeight: 600, color: '#2e7d32', borderBottom: '2px solid #2e7d32' }}>{headers.nlb}</th>
              <th style={{ padding: '0.75rem 1rem', textAlign: 'center', fontSize: '0.8rem', fontWeight: 600, color: '#2e7d32', borderBottom: '2px solid #2e7d32' }}>{headers.improvement}</th>
            </tr>
          </thead>
          <tbody>
            {rows.map((row, idx) => (
              <tr key={idx} style={{ background: row.isTotal ? '#e8f5e9' : '#fff', borderBottom: '1px solid var(--ifm-color-emphasis-200)' }}>
                <td style={{ padding: '0.7rem 1rem', fontSize: '0.82rem', fontWeight: row.isTotal ? 700 : 600, color: 'var(--ifm-font-color-base)' }}>{row.component}</td>
                <td style={{ padding: '0.7rem 1rem', textAlign: 'center', fontSize: '0.78rem', color: 'var(--ifm-color-emphasis-600)' }}>{row.alb}</td>
                ...
                <td style={{ padding: '0.7rem 1rem', textAlign: 'center' }}>
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem' }}>
                    <div style={{ width: 60, height: 18, background: 'var(--ifm-color-emphasis-100)', borderRadius: 4, overflow: 'hidden', border: '1px solid #4caf50' }}>
