    ...
    items: [
      {
        ...
        description: 'eBPF VM · Verifier · JIT · CO-RE/BTF · Ring Buffer · 제품 지형도 · Falco vs Tetragon · Off-CPU & 스로틀링 진단 · VPC CNI NetworkPolicy · NFM sock_ops · Cilium ENI · 실측 벤치마크 · EN 기본 / KO 전환 버튼',
        badge: 'Deep Dive',
        slides: 39,
