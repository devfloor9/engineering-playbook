---
title: "EKS PCP 层级选型与性能验证指南"
sidebar_label: "PCP Tier Sizing"
description: "PCP 各层级详细参数、APF seat 计算公式、大规模集群选型示例、ClusterLoader2 性能验证方法论、客户案例"
...
:::tip 相关文档
Control Plane 架构概述、CRD 影响分析、监控设置、CRD 设计最佳实践请参阅 **[EKS Control Plane & CRD at Scale 综合指南](./eks-control-plane-crd-scaling)**。
:::
