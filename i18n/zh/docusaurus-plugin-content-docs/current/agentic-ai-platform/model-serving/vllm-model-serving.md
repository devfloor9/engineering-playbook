...
详细内容请参阅 [自定义模型部署指南](../reference-architecture/custom-model-deployment.md)。
...
:::info 详细指南
Multi-LoRA 热交换部署、客户级适配器路由、A/B 测试、S3 动态加载等详细实现请参阅 [自定义模型流水线指南](../reference-architecture/custom-model-pipeline.md)。
:::
