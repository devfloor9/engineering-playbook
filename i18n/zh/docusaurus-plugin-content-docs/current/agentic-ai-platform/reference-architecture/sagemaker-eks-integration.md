...
sidebar_label: "SageMaker-EKS 集成"
description: "在 SageMaker 训练、在 EKS 服务的混合 ML 架构"
sidebar_position: 4
category: "genai-aiml"
...
本文档的详细内容（SageMaker 训练作业配置、模型注册、EKS 推理部署、ACK 集成等）由于篇幅原因请参阅[韩文原文](/docs/agentic-ai-platform/reference-architecture/sagemaker-eks-integration)。
