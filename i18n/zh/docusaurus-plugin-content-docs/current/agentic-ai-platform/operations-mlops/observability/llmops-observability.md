...
:::info 实战部署指南
Langfuse Helm 部署、Redis/ClickHouse 配置、kgateway sub-path 路由、Bifrost OTel 联动等实战配置请参阅 [监控栈配置指南](../../reference-architecture/integrations/monitoring-observability-setup.md)。
:::
...
Ragas 是 RAG 系统专用评估框架，与 Langfuse 集成提供更精确的评估。详情请参阅 [RAG Evaluation with Ragas](../governance/ragas-evaluation.md)。
...
### 相关文档
- [监控栈配置指南](../../reference-architecture/integrations/monitoring-observability-setup.md) - Langfuse 部署、Bifrost OTel 联动、kgateway 路由实战配置
- [Bifrost Gateway 配置指南](../../reference-architecture/inference-gateway/routing-strategy.md)
