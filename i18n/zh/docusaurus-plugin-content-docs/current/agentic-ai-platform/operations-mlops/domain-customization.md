...
QLoRA 训练方法、NeMo/Unsloth 框架、检查点管理等详细实现请参阅 [自定义模型流水线指南](../reference-architecture/custom-model-pipeline.md#2-lora-fine-tuning-流水线)。
...
各 Phase 详细实现指南请参阅 [自定义模型流水线构建指南](../reference-architecture/custom-model-pipeline.md#6-分阶段构建路线图)。
