...
sidebar_label: "DRA Architecture"
description: "Implementation guide for dynamic resource allocation (DRA) for hybrid GPU/CPU node configurations in Amazon EKS clusters"
...
Amazon EKS's Dynamic Resource Allocation (DRA) supports flexible resource management for workloads requiring both GPU and CPU resources. This document describes the architecture and implementation patterns for hybrid node configuration.
