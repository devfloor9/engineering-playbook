...
For detailed cost comparison between self-hosting and Bedrock (break-even points, Cascade Routing savings), refer to [Coding Tools Cost Analysis](../reference-architecture/coding-tools-cost-analysis.md).
:::
...
- **Level 2 (Build)**: → [SageMaker-EKS Integration](../reference-architecture/sagemaker-eks-integration.md)
- **Level 3 (Optimization)**: → [EKS-based Open Architecture](./agentic-ai-solutions-eks.md), [Inference Gateway](../reference-architecture/inference-gateway-routing.md)
...
**Reference**: [Inference Gateway & Cascade Routing](../reference-architecture/inference-gateway-routing.md)
...
**Reference**: [SageMaker-EKS Integration](../reference-architecture/sagemaker-eks-integration.md)
...
**Reference**: For technical implementation of hybrid architecture, refer to [SageMaker-EKS Integration](../reference-architecture/sagemaker-eks-integration.md).
...
:::info Detailed Cost Analysis
For detailed analysis of instance costs, Spot savings rates, and Cascade Routing effects, refer to [Coding Tools Cost Analysis](../reference-architecture/coding-tools-cost-analysis.md).
:::
...
- [Inference Gateway & Cascade Routing](../reference-architecture/inference-gateway-routing.md) — 2-Tier Gateway architecture

### Reference Architecture
- [SageMaker-EKS Integration](../reference-architecture/sagemaker-eks-integration.md) — Hybrid ML pipeline implementation
- [Coding Tools Cost Analysis](../reference-architecture/coding-tools-cost-analysis.md) — Bedrock vs self-hosting break-even analysis
- [Custom Model Deployment](../reference-architecture/custom-model-deployment.md) — vLLM deployment practical guide
