...
- [SageMaker-EKS 통합](../reference-architecture/sagemaker-eks-integration.md) — Hybrid VPC/IAM reference
:::
...
Hybrid approach becomes cost-effective at 500K+ monthly inference volumes. [Coding Tools Cost Analysis](../reference-architecture/coding-tools-cost-analysis.md)for detailed calculation formulas.
:::
...
- [Coding Tools Cost Analysis](../reference-architecture/coding-tools-cost-analysis.md)
