...
This document covers the **hands-on deployment procedures** for integrated monitoring with Prometheus to AMP, AMG, Langfuse, and Bifrost OTel. For architecture concepts and design principles, see [Agent Monitoring](../operations-mlops/agent-monitoring.md) and [LLMOps Observability](../operations-mlops/llmops-observability.md).
...
- [Agent Monitoring](../operations-mlops/agent-monitoring.md) - Detailed monitoring architecture and metric design
- [LLMOps Observability](../operations-mlops/llmops-observability.md) - Langfuse/LangSmith/Helicone comparison and evaluation pipelines
