...
For detailed QLoRA training, NeMo/Unsloth frameworks, and checkpoint management, see the [Custom Model Pipeline Guide](../reference-architecture/custom-model-pipeline.md#2-lora-fine-tuning-pipeline).
...
For detailed per-phase implementation guides, see the [Custom Model Pipeline Guide](../reference-architecture/custom-model-pipeline.md#6-phase-by-phase-roadmap).
