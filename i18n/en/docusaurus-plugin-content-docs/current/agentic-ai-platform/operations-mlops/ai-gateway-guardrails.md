...
- [Inference Gateway Routing](../reference-architecture/inference-gateway-routing.md): kgateway + Bifrost 2-Tier Gateway
:::
...
For detailed design, refer to [Inference Gateway Routing](../reference-architecture/inference-gateway-routing.md).
:::
...
- [Inference Gateway Routing](../reference-architecture/inference-gateway-routing.md) — 2-Tier Gateway design
- [EKS-based Agentic AI Open Architecture](../design-architecture/agentic-ai-solutions-eks.md)
