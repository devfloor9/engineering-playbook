  ...
  return (
    <SlideWrapper>
      <div className="flex items-center gap-4 mb-4">
        <Badge color="blue" size="lg" className="text-2xl px-5 py-2">Track 1</Badge>
        <h2 className="text-5xl font-bold text-blue-300">Modern Agentic Infra</h2>
      </div>
      <p className="text-xl text-gray-400 mb-4">
        EKS + GPU + Hybrid Nodes — AI-ready 인프라의 기반
      </p>
      ...
      <div className="flex-1 flex flex-col justify-center space-y-5">
        <div className="grid grid-cols-2 gap-5">
          ...
          <Card color="amber" className="p-5">
            ...
            <h4 className="text-xl font-semibold mb-2 text-amber-300">Karpenter + Hybrid Nodes</h4>
            <p className="text-base text-gray-300">
              GPU 인스턴스 자동 프로비저닝 + 온프레미스 Hybrid Nodes 통합.
              H100, L40S, Inferentia2 지원
            </p>
          </Card>
        </div>
        ...
        <div className="bg-blue-500/20 rounded-xl px-8 py-5 border-2 border-blue-400/60 text-center" style={{boxShadow: '0 0 30px rgba(59, 130, 246, 0.2)'}}>
          ...
          <p className="text-base text-gray-300 mt-2">
            GPU Operator + run.ai + MIG + Karpenter + Hybrid Nodes + Semantic Caching
          </p>
        </div>
      </div>
    </SlideWrapper>
