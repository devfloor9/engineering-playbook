        ...
        <div className="grid grid-cols-2 gap-6">
          <Card className="p-6">
            <div className="flex items-start gap-4 mb-4">
              ...
              <div>
                <Badge className="mb-2 bg-red-500/20 text-red-300">도전과제 1</Badge>
          ...
          <Card className="p-6">
            <div className="flex items-start gap-4 mb-4">
              ...
              <div>
                <Badge className="mb-2 bg-cyan-500/20 text-cyan-300">도전과제 2</Badge>
          ...
          <Card className="p-6">
            <div className="flex items-start gap-4 mb-4">
              ...
              <div>
                <Badge className="mb-2 bg-blue-500/20 text-blue-300">도전과제 3</Badge>
          ...
          <Card className="p-6">
            <div className="flex items-start gap-4 mb-4">
              ...
              <div>
                <Badge className="mb-2 bg-emerald-500/20 text-emerald-300">도전과제 4</Badge>
