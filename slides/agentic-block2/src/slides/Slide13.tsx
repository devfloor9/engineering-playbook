  ...
  return (
    <SlideWrapper>
      <div className="flex-1 flex flex-col p-12">
        ...
        <p className="text-xl text-gray-300 mb-6">분산 구조로 대규모 벡터 검색 지원</p>
          ...
          <Card className="p-6">
            ...
            <div className="space-y-3">
              <div className="p-3 bg-gray-800/50 rounded">
                ...
                <div className="text-xs text-gray-300">메타데이터 저장 (스키마, 인덱스 정보)</div>
              </div>
              <div className="p-3 bg-gray-800/50 rounded">
                <div className="text-sm font-semibold text-emerald-400 mb-1">S3/MinIO</div>
                <div className="text-xs text-gray-300">벡터 데이터 및 인덱스 파일 영구 저장</div>
              </div>
              <div className="p-3 bg-gray-800/50 rounded">
                <div className="text-sm font-semibold text-amber-400 mb-1">Pulsar/Kafka</div>
                <div className="text-xs text-gray-300">메시지 큐, 데이터 스트림 처리</div>
              </div>
            </div>
          </Card>
        </div>
