  ...
  return (
    <SlideWrapper>
      <div className="flex-1 flex flex-col p-12">
        ...
        <p className="text-xl text-gray-300 mb-6">완전 관리형 AI Agent 런타임 및 MCP 프로토콜</p>
          ...
          <Card className="p-6">
            ...
            <div className="space-y-3">
              <div className="p-3 bg-gray-800/50 rounded">
                ...
                <div className="text-xs text-gray-300">AI 에이전트 관리형 실행 환경 (Strands/LangGraph)</div>
              </div>
              <div className="p-3 bg-gray-800/50 rounded">
                <div className="text-sm font-semibold text-blue-400 mb-1">AgentCore Gateway</div>
                <div className="text-xs text-gray-300">MCP 프로토콜 라우터, Cognito JWT 인증</div>
              </div>
              <div className="p-3 bg-gray-800/50 rounded">
                <div className="text-sm font-semibold text-emerald-400 mb-1">MCP Tools</div>
                <div className="text-xs text-gray-300">Lambda, EKS MCP 서버, 커스텀 도구</div>
              </div>
            </div>
          </Card>
        </div>
        ...
        <div className="mt-4 p-4 bg-gray-800/50 rounded-lg border border-amber-500/30">
