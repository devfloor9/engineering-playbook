  ...
  return (
    <SlideWrapper>
      <div className="flex-1 flex flex-col p-12">
        ...
        <p className="text-xl text-gray-400 mb-6">Kubernetes 1.33+ 크로스 AZ 최적화</p>
          ...
          <Card className="p-6">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center p-3 bg-gray-800/50 rounded">
                <span className="text-sm text-gray-400">크로스 AZ 트래픽</span>
                <span className="text-xl font-bold text-red-400">↓ 90%</span>
              </div>
              <div className="flex justify-between items-center p-3 bg-gray-800/50 rounded">
                <span className="text-sm text-gray-400">P50 지연 시간</span>
                <span className="text-xl font-bold text-emerald-400">↓ 30%</span>
              </div>
              <div className="flex justify-between items-center p-3 bg-gray-800/50 rounded">
                <span className="text-sm text-gray-400">P99 지연 시간</span>
                <span className="text-xl font-bold text-blue-400">↓ 50%</span>
              </div>
              <div className="flex justify-between items-center p-3 bg-gray-800/50 rounded">
                <span className="text-sm text-gray-400">데이터 전송 비용</span>
