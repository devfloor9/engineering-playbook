  ...
  return (
    <SlideWrapper>
      <div className="flex-1 flex flex-col p-12">
        ...
        <p className="text-xl text-gray-300 mb-6">폴백, 타임아웃, 재시도, 서킷 브레이커</p>
        ...
        <div className="mt-6 grid grid-cols-3 gap-4">
          <div className="p-4 bg-gray-800/50 rounded-lg border border-red-500/30">
            ...
            <p className="text-xs text-gray-300">LLM 추론은 시간이 오래 걸릴 수 있으므로 충분한 타임아웃 설정 필요</p>
          </div>
          <div className="p-4 bg-gray-800/50 rounded-lg border border-amber-500/30">
            ...
            <p className="text-xs text-gray-300">무한 재시도는 시스템 과부하를 유발할 수 있음</p>
          </div>
          <div className="p-4 bg-gray-800/50 rounded-lg border border-purple-500/30">
            ...
            <p className="text-xs text-gray-300">너무 민감한 설정은 정상 트래픽도 차단할 수 있음</p>
          </div>
        </div>
      </div>
    </SlideWrapper>
