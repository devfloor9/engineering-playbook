      ...
      <div className="grid grid-cols-2 gap-6 mb-6">
        <Card>
          ...
          <div className="space-y-2">
            <Badge color="cyan">검색 품질</Badge>
            <Badge color="blue">답변 충실도</Badge>
            <Badge color="purple">답변 관련성</Badge>
            <Badge color="emerald">정확성</Badge>
          </div>
        </Card>
          ...
          <ul className="space-y-3 text-gray-300">
            <li className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">검색 → 컨텍스트 → 생성</p>
              </div>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-emerald-400 mt-1">▸</span>
              <div>
                <strong>환각 감지</strong>
                <p className="text-sm text-gray-400">답변이 컨텍스트에 충실한지</p>
              </div>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-emerald-400 mt-1">▸</span>
              <div>
                ...
                <p className="text-sm text-gray-400">품질 메트릭 기반 최적화</p>
              </div>
            </li>
          </ul>
        </Card>
      ...
      <Card className="bg-gray-800/50">
        ...
        <div className="grid grid-cols-4 gap-3">
          <div className="bg-blue-500/20 border border-blue-500/30 rounded-lg p-3 text-center">
            ...
            <div className="text-xs text-gray-400 mt-1">Precision/Recall</div>
          </div>
          <div className="bg-emerald-500/20 border border-emerald-500/30 rounded-lg p-3 text-center">
            ...
            <div className="text-xs text-gray-400 mt-1">Faithfulness</div>
          </div>
          <div className="bg-amber-500/20 border border-amber-500/30 rounded-lg p-3 text-center">
            ...
            <div className="text-xs text-gray-400 mt-1">Relevancy</div>
          </div>
          <div className="bg-purple-500/20 border border-purple-500/30 rounded-lg p-3 text-center">
            ...
            <div className="text-xs text-gray-400 mt-1">Correctness</div>
          </div>
        </div>
      </Card>
    </SlideWrapper>
